...
![Step 1 — Stop MongoDB and Wipe Clean](<img/Step 1: Stop MongoDB and Wipe Clean.png>)
...
![Step 2 — Start MongoDB Without Auth](<img/Step 2: Start MongoDB WITHOUT Auth.png>)
...
![Step 3 — Create Root Admin User](<img/Step 3: Create the Root Admin User Inside mongosh .png>)
...
![Step 4 — Write Config File](<img/Step 4: Write the Config File with Auth Enabled.png>)
...
![Step 5 — Restart MongoDB with Auth](<img/Step 5: Restart MongoDB WITH Auth.png>)
...
![Step 6 — Test With Credentials](<img/Step 6: Test WITH Credentials.png>)
...
![Step 7 — Test Without Credentials](<img/Step 7: Test WITHOUT Credentials.png>)
